            ...
            <form method="post" action="/upd">
                <table class="table table-hover  table-striped table-condensed text-center">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="col-sm-10">
                                ...
                                <input  hidden name="sum1"  value="${sum1}">
                                <input  hidden name="total1"  value="${total1}">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="col-sm-10">
                                <input  class="form-control" name="beizhu"  value="${beizhu}">
                            </div>
                        </td>
                    </tr>
                    <tr>
                ...
                <a href="/food?orderid=${orderid}" class="btn btn-danger btn-lg btn-block">取消订单</a>
            </form>
        </div>
